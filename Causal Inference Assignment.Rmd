...
#Treatment is any kind of intervention, control is no intervention whatsoever (assigned 'None' in foo$untype)
...
propensity_mout_2 <- Match(Y=foo$pbs2l,Tr=Tr, X=glm_propensity$fitted, estimand="ATT")
propensity_mout_5 <- Match(Y=foo$pbs5l,Tr=Tr, X=glm_propensity$fitted, estimand="ATT")
summary(propensity_mout_2)
summary(propensity_mout_5)
...
genout <- GenMatch(Tr=foo$untype, X=Xgen, estimand="ATT",
                   pop.size=200, max.generations=25, wait.generations=25)


mout2 <- Match(Y=foo$pbs2l,Tr=foo$untype, X=Xgen, estimand="ATT", Weight.matrix=genout)
summary(mout2)
